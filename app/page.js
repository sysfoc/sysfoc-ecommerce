    ...
    <div className="">
      ...
      <div className="my-10 md:my-20 flex justify-center items-center">
          <div className="w-full sm:w-[75%] text-center">
            <p><strong>Akbar Aslams</strong> is a luxury womens ethnic brand that combines modern aesthetic with age-old traditions. Our handcrafted and hand-embellished dresses are made by master craftsmen, ensuring the highest quality and commitment to our customers.</p>
