    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <div className="text-center mb-6">
          ...
          <p className="text-gray-600 dark:text-gray-300 mt-2">Welcome back to your account</p>
        </div>

        {error && (
          <div className="mb-4 p-4 text-sm text-red-800 dark:text-red-200 rounded-lg bg-red-50 dark:bg-red-900 border border-red-200 dark:border-red-700">{error}</div>
        )}
        ...
        <p className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
          ...
          <a href="/sign-up" className="text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300 font-medium">
            Sign up
          </a>
        </p>
      </div>
